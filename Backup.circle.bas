...
END FUNCTION
 ...
 FUNCTION BUILDWINDOW() AS LONG
    ...
    CONTROL ADD LABEL, hDlg, %IDC_LABEL1, TXT$, 500, 150, 84, 20
    CONTROL ADD TEXTBOX, hDlg, %IDC_EDITBOX2, "", 600, 170, 80, 20, , , _
    CALL EditControlCallback() ' Use default styles
    CONTROL ADD LABEL, hDlg, %IDC_LABEL2, TXT$, 500, 170, 84, 20
    ...
    CALL EditControlCallback() ' Use default styles
    CONTROL ADD LABEL, hDlg, %IDC_LABEL4, TXT$, 500, 230, 84, 20
    CONTROL ADD TEXTBOX, hDlg, %IDC_EDITBOX5, "", 600, 250, 80, 20, , , _
    CALL EditControlCallback() ' Use default styles
    CONTROL ADD LABEL, hDlg, %IDC_LABEL5, TXT$, 500, 250, 84, 20
    CONTROL ADD TEXTBOX, hDlg, %IDC_EDITBOX6, "", 600, 270, 80, 20, , , _
    CALL EditControlCallback() ' Use default styles
    CONTROL ADD LABEL, hDlg, %IDC_LABEL6, TXT$, 500, 270, 82, 20
    CONTROL ADD TEXTBOX, hDlg, %IDC_EDITBOX7, "", 600, 290, 80, 20, , , _
    CALL EditControlCallback() ' Use default styles
    CONTROL ADD LABEL, hDlg, %IDC_LABEL7, TXT$, 500, 290, 82, 20
    CONTROL ADD TEXTBOX, hDlg, %IDC_EDITBOX8, "", 600, 310, 80, 20, , , _
    CALL EditControlCallback() ' Use default styles
    CONTROL ADD LABEL, hDlg, %IDC_LABEL8, TXT$, 500, 310, 82, 20
    CONTROL ADD TEXTBOX, hDlg, %IDC_EDITBOX9, "", 600, 330, 80, 20, , , _
    CALL EditControlCallback() ' Use default styles
    CONTROL ADD LABEL, hDlg, %IDC_LABEL9, TXT$, 500, 330, 82, 20
    CONTROL ADD TEXTBOX, hDlg, %IDC_EDITBOX10, "", 600, 350, 80, 20, , , _
    CALL EditControlCallback() ' Use default styles
    CONTROL ADD LABEL, hDlg, %IDC_LABEL10, TXT$, 500, 350, 82, 20
    CONTROL ADD TEXTBOX, hDlg, %IDC_EDITBOX11, "", 600, 370, 80, 20, , , _
    CALL EditControlCallback() ' Use default styles
    CONTROL ADD LABEL, hDlg, %IDC_LABEL11, TXT$, 500, 370, 82, 20
