...
uint32_t x;                               
       ...
       HAL_ADC_Start(&hadc1);                   // start ADC 1, next conversion
       ...
       PCount1=speed-2048;
        ...
        if(HAL_GPIO_ReadPin(REMOTE_X_i_GPIO_Port,REMOTE_X_i_Pin)==PRESSED) {  // Xasis pressed    
            ...
            if(PCount1<=X_DEADBAND) {
                ...
                TIM10->ARR=x-20;                    // initialize remote interrupt rate                           
                ...
                TIM13->ARR=x-20;                    // initialize remote interrupt rate                           
        ...
        if(HAL_GPIO_ReadPin(REMOTE_Y_i_GPIO_Port,REMOTE_Y_i_Pin)==PRESSED) {     // Y asis pressed
            ...
            if(PCount2<=Y_DEADBAND){
                ...
                TIM11->ARR=x-20;                    // initialize remote interrupt rate                           
                ...
                TIM14->ARR=x-20;                    // initialize remote interrupt rate                           
        ...
        if(HAL_GPIO_ReadPin(REMOTE_Z_i_GPIO_Port,REMOTE_Z_i_Pin)==PRESSED) {   // Z asis pressed
            ...
            if(PCount3<=Z_DEADBAND) {
                ...
                TIM12->ARR=x-20;                    // initialize remote interrupt rate                           
