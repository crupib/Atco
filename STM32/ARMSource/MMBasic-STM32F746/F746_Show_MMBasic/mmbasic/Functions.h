...
// new functions for STM32F7
void fun_irnd(void);
void fun_acos(void);
void fun_asin(void);
void fun_calcco(void);
void fun_calcsi(void);
void fun_fwidth(void);
void fun_fheight(void);
...
// and P is the precedence (which is only used for operators)
	...
	{ "CalcCos(",	T_FUN  | T_NBR,			0, fun_calcco	},// new function for STM32F7
	{ "CalcSin(",	T_FUN  | T_NBR,			0, fun_calcsi	},// new function for STM32F7
	...
	{ "IntRnd",		T_FNA  | T_NBR,			0, fun_irnd		},// new function for STM32F7
	{ "ACos(",		T_FUN  | T_NBR,			0, fun_acos		},// new function for STM32F7
	{ "ASin(",		T_FUN  | T_NBR,			0, fun_asin		},// new function for STM32F7
	{ "MM.FontWidth",   T_FNA | T_NBR,		0, fun_fwidth 	},// new function for STM32F7
	{ "MM.FontHeight",  T_FNA | T_NBR,		0, fun_fheight 	},// new function for STM32F7
