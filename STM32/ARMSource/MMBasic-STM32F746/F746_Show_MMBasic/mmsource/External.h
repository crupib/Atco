...
// and P is the precedence (which is only used for operators)
	...
	{ "JoyGet(",	T_FUN | T_NBR,		0, fun_joyget	},
...
#define EXT_DIN_PULL_NONE       0
#define EXT_DIN_PULL_UP      1024 // Bit for pull up
#define EXT_DIN_PULL_DOWN    2048 // Bit for pull down
