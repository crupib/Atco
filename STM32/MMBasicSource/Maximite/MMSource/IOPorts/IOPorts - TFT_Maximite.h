...
Include file that defines the IOPins for the PIC32 chip in the TFT Maximite version of MMBasic.
...
#define NBRPINS				34						// number of pins for external i/o
...
#define P_COM2_RX_PORT		PORTCbits.RC3

#define P_COM2_TX_PIN_NBR	20
#define P_COM2_TX_SET_HI	LATASET = (1 << 0)
#define P_COM2_TX_SET_LO	LATACLR = (1 << 0)
