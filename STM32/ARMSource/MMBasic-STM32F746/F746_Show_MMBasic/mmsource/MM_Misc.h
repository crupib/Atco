...
#define MISC_HEADER
  ...
  extern int mSecTimer;
  extern int mPauseTimer;
  extern int iPauseTimer;
  ...
  extern int month;
  extern int year;
  extern const char DaysInMonth[];
  extern const unsigned int DriveOption;
  extern const unsigned int BGColorOption;
  extern const unsigned int FGColorOption;
  extern const unsigned int AutorunOption;
  extern const unsigned int BaudrateOption;
