...
uint32_t temp1,temp2,temp3;
    ...
    temp1=TIM2->CNT;                  // get encoder 1 value, 32 bits
    ...
    temp2=(UpperWord2<<16)  | temp2;
    temp3=(UpperWord3<<16)  | temp3;

    __disable_irq();  // disable interrupts while updating encoders
    EncPos1= temp1;
    EncPos2= temp2;  // Combine upper and lower words
    EncPos3= temp3;  // Combine upper and lower words
    __enable_irq();
