...
extern void  fp_maxmin_expand32_asm( char *input_maxmin_array,  
                               char *input_tof_array,
                               char *output_array,
                               unsigned long  scale,
                               unsigned long input_size );
...
extern void fp_video_filter32_asm(unsigned char * ibuff, unsigned char * obuff,
...
extern int  fp_peak_find32_asm( char *buff,
						  unsigned length,
						  int threshold,
		                  int threshold_sense,
			              int absolute_value,
                          int data_type,
						  int edge_level_logic,
                          unsigned *time_of_flight );

extern void  interlb32_asm(int n,   long long inc,  void *bufi,  void *bufo );
...
extern void  interl32_asm( short int n,  long inc,  void *bufi,  void *bufo );
...
DLLExport void fp_maxmin32_expand( char *input_maxmin_array,  
                               char *input_tof_array,
                               char *output_array,
                               unsigned long  scale,
                               unsigned long input_size )
{
	fp_maxmin_expand32_asm( input_maxmin_array,  
                          input_tof_array,
                          output_array,
                          scale,
                          input_size );
...
DLLExport void  fp_video_filter(unsigned char * ibuff, unsigned char * obuff,
					    short int buflen,  unsigned int filter)
{
	fp_video_filter_asm(ibuff, obuff, buflen, filter);
}

DLLExport void  fp_video_filter32(unsigned char * ibuff, unsigned char * obuff,
					    int buflen,  unsigned int filter)
{
	fp_video_filter32_asm(ibuff, obuff, buflen, filter);
}
...
DLLExport int fp_peak_find32( char *buff,
						  unsigned length,
						  short int threshold,
		                  short int threshold_sense,
			              short int absolute_value,
                          ...
                          short unsigned *time_of_flight )
{
	return fp_peak_find32_asm(buff, length, threshold, threshold_sense, absolute_value,
                           data_type, edge_level_logic, time_of_flight );
}
...
DLLExport void  interlb32(int n,  long long inc,  void *bufi,  void *bufo )
{
	interlb32_asm(  n,   inc,  bufi,  bufo );
}
...
DLLExport void  interl32(int n,   long inc,  void *bufi,  void *bufo )
{
	interl32_asm(  n,   inc,  bufi,  bufo );
}
...
DLLExport void  xlate32(char * inarray, char * outarray, char * table, int num)
{
	__asm
	{
			mov	esi,dword ptr inarray
...
//already created
DLLExport void  xlate_32(unsigned * inarray, unsigned  * outarray, unsigned  * table, unsigned int num)
{
	__asm
		{
			xor edx,edx
...
DLLExport void  xlatergb32(char * inarray, char * outarray, int * table, int num)
{
	__asm
    {  
		mov ecx,256
...
DLLExport void  xferco32( void *from,  void *to, unsigned nbytes, int hinge )
{
	__asm
	{
		xor edx,edx
...
DLLExport void  compsl( unsigned short int len,  short int ifac,  unsigned char *xdat)
{
	__asm
	{
