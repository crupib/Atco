...
Include file that defines the IOPins for UBW32 MMBasic.
...
struct s_PinDef PinDef[NBRPINS + 1] = {
    ...
    { ADDR_PORTB,  2, ANALOG_IN | DIGITAL_IN | INTERRUPT | DIGITAL_OUT  },            // pin 3
    { ADDR_PORTB,  1, ANALOG_IN | DIGITAL_IN | INTERRUPT | DIGITAL_OUT  },            // pin 4
    ...
    { ADDR_PORTD, 12, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 15
    { ADDR_PORTD, 13, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 16
    { ADDR_PORTE,  4, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 17
    { ADDR_PORTE,  5, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 18
    { ADDR_PORTD, 14, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 19
    { ADDR_PORTD, 15, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 20
    { ADDR_PORTA,  0, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 21
    { ADDR_PORTA,  1, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 22
    { ADDR_PORTA,  2, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 23
    { ADDR_PORTA,  3, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 24
    { ADDR_PORTA,  4, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 25
    { ADDR_PORTA,  5, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 26
    { ADDR_PORTA,  6, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 27
    { ADDR_PORTA,  7, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 28
    { ADDR_PORTA,  9, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 29
    { ADDR_PORTA, 10, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 30
    { ADDR_PORTD, 10, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 31
    { ADDR_PORTD,  9, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 32
    { ADDR_PORTC,  1, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 33
    { ADDR_PORTC,  2, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 34
    { ADDR_PORTC,  3, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 35
    { ADDR_PORTC,  4, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 36
    { ADDR_PORTD, 11, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 37
    { ADDR_PORTF,  8, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 38
    { ADDR_PORTF, 12, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 39
    { ADDR_PORTB, 14, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 40
    { ADDR_PORTG,  0, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 41
    { ADDR_PORTG,  1, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 42
    { ADDR_PORTG, 12, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 43
    { ADDR_PORTG, 13, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 44
    { ADDR_PORTG, 14, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 45
    { ADDR_PORTG, 15, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 46
    { ADDR_PORTF,  2, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 47
    { ADDR_PORTE,  2, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 48
    { ADDR_PORTE,  3, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 49
    { ADDR_PORTE,  6, DIGITAL_IN | INTERRUPT | DIGITAL_OUT | OC_OUT },                // pin 50
};
#else
...
#define SD_CS_SET_HI        LATDSET = (1 << 8)		// SD-SPI Chip Set Output bit high
#define SD_CS_SET_LO        LATDCLR = (1 << 8)		// SD-SPI Set Output bit low
#define SD_CS_TRIS          TRISDbits.TRISD8		// SD-SPI Chip Select TRIS bit
