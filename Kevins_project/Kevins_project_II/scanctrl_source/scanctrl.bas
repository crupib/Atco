...
GLOBAL AppXMotorState&
%MAIN_TEXTYPOS           = 115
%MAIN_BUTTONYPOS         = 120
%MAIN_BUTTONYONOFF       = 125
GLOBAL AppYMotorState&
%MAIN_TEXTRPOS           = 130
%MAIN_BUTTONRPOS         = 135
%MAIN_BUTTONRONOFF       = 140
GLOBAL AppRMotorState&
...
FUNCTION ShowInputBox(BYVAL Title$, BYVAL IDesc$, BYVAL IValue$) AS STRING
...
SUB EZ_INPUTBOX_Design()     ' (PROTECTED)
     ...
     EZ_UseFont 4
     EZ_UseAutoSize "VH"
     EZ_Text %INPUTBOX_TEXTINPUTDATA, .5, 3, 49, 1.875, App_InputValue$, "EST"
     ' -----------------------------------------------
     EZ_Color-1,-1
     EZ_UseFont 4
     EZ_UseAutoSize "VH"
...
SUB EZ_MAIN_Design()
     ...
     EZ_UseFont 6
     EZ_UseAutoSize "VH-2"
     EZ_ODButton %MAIN_BUTTONXONOFF, 27.625, .25, 11.75, 1.75, MakeButtonRedGreen("  X Motor ON",AppXMotorState&), "T"
     ...
     EZ_UseFont 6
     EZ_UseAutoSize "VH-2"
     EZ_ODButton %MAIN_BUTTONYONOFF, 27.625, 2.375, 11.75, 1.75, MakeButtonRedGreen("  Y Motor ON",AppYMotorState&), "T"
     ...
     EZ_UseFont 6
     EZ_UseAutoSize "VH-2"
     EZ_ODButton %MAIN_BUTTONRONOFF, 27.625, 4.5, 11.75, 1.75, MakeButtonRedGreen("  R Motor ON",AppRMotorState&), "T"
...
SUB EZ_MAIN_ParseEvents(CID&, CMsg&, CVal&, Cancel&)
     ...
     SELECT CASE CID&
          ...
          CASE  %MAIN_BUTTONXPOS
               SELECT CASE CMsg&
                    CASE %EZ_Click, %EZ_DClick
                         ...
                         RV$=ShowInputBox("Set X Position", "Enter New X Position",EText$)
                         IF RV$<>EText$ THEN
          ...
          CASE  %MAIN_BUTTONXONOFF
               SELECT CASE CMsg&
                    CASE %EZ_Click, %EZ_DClick
                         IF AppXMotorState&=0 THEN AppXMotorState&=1 ELSE AppXMotorState&=0
                         SetRedGreenState "MAIN", CID&, AppXMotorState&
                    CASE %EZ_OwnerDraw
          ...
          CASE  %MAIN_BUTTONYPOS
               SELECT CASE CMsg&
                    CASE %EZ_Click, %EZ_DClick
                         ...
                         RV$=ShowInputBox("Set Y Position", "Enter New Y Position",EText$)
                         IF RV$<>EText$ THEN
          ...
          CASE  %MAIN_BUTTONYONOFF
               SELECT CASE CMsg&
                    CASE %EZ_Click, %EZ_DClick
                         IF AppYMotorState&=0 THEN AppYMotorState&=1 ELSE AppYMotorState&=0
                         SetRedGreenState "MAIN", CID&, AppYMotorState&
                    CASE %EZ_OwnerDraw
          ...
          CASE  %MAIN_BUTTONRPOS
               SELECT CASE CMsg&
                    CASE %EZ_Click, %EZ_DClick
                         ...
                         RV$=ShowInputBox("Set R Position", "Enter New R Position",EText$)
                         IF RV$<>EText$ THEN
          ...
          CASE  %MAIN_BUTTONRONOFF
               SELECT CASE CMsg&
                    CASE %EZ_Click, %EZ_DClick
                         IF AppRMotorState&=0 THEN AppRMotorState&=1 ELSE AppRMotorState&=0
                         SetRedGreenState "MAIN", CID&, AppRMotorState&
                    CASE %EZ_OwnerDraw
          ...
          CASE  %MAIN_BUTTONALLPOS
               SELECT CASE CMsg&
                    CASE %EZ_Click, %EZ_DClick
                         EText$=""
                         RV$=ShowInputBox("Set All Positions", "Enter New X,Y,R (All) Position",EText$)
                         IF RV$<>EText$ THEN
                              EZ_SetText "MAIN", %MAIN_TEXTXPOS, RV$
                              EZ_SetText "MAIN", %MAIN_TEXTYPOS, RV$
                              EZ_SetText "MAIN", %MAIN_TEXTRPOS, RV$
                              ProcessInput(%BC_MY_TEST, 1.5, 1.6, 1.7, 1.8)
                              GuiRequest(%BC_MY_TEST)
                         END IF
                    CASE %EZ_OwnerDraw
