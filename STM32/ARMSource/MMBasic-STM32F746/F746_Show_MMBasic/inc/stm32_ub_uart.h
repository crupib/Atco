...
#define    COM7_RTS_PORT        GPIOF
#define    COM7_RTS_PIN         GPIO_PIN_8
#define    COM7_CTS_PORT        GPIOF
#define    COM7_CTS_PIN         GPIO_PIN_9
...
//--------------------------------------------------------------
#define  RX_BUF_SIZE_COM1  128    // Groesse vom RX-Puffer in Bytes (COM1)
#define  RX_BUF_SIZE_COM6  64     // Groesse vom RX-Puffer in Bytes (COM6)
#define  RX_BUF_SIZE_COM7  64     // Groesse vom RX-Puffer in Bytes (COM7)
